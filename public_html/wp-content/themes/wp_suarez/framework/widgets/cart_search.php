...
class WC_Widget_Cart_Search extends WP_Widget {
    function WC_Widget_Cart_Search() {
        parent::__construct(
    ...
    function widget($args, $instance) {
        ...
        <div class="widget_cart_search_wrap">
            ...
            <div class="shopping_cart_dropdown">
                        ...
                        <?php if ( !$cart_is_empty ) : ?>
                            <?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
                                ...
                                <li class="cart-list clearfix">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 nopaddingall">
                ...
                <?php endif; ?>
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="btn btn-default left wc-forward"><?php _e( 'Cart', 'woocommerce' ); ?></a>
...
if(!function_exists('woocommerce_header_add_to_cart_content')){
    ...
    ob_start();
    ?>
    <div class="shopping_cart_dropdown test">
        <div class="shopping_cart_dropdown_inner">
            <?php
            $cart_is_empty = sizeof( $woocommerce->cart->get_cart() ) <= 0;
            $list_class = array( 'cart_list', 'product_list_widget' );
