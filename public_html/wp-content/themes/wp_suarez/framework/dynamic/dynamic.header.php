...
if ($smof_data['background-header']) {
    ...
    echo cshero_backgrounds_render($smof_data["background-header"], 'body #cshero-header.transparentFixed');
...
/* Main Header */
#cshero-header {
    border-bottom:<?php echo esc_attr($smof_data['header_border_bottom_style']);?> <?php echo esc_attr($smof_data['header_border_bottom_height']);?> <?php echo esc_attr($smof_data['header_border_bottom_color']);?>;
}
...
#cshero-header .widget_cart_search_wrap a.icon_search_wrap,
...
#cshero-header .widget_cart_search_wrap a.icon_search_wrap:hover,
#cshero-header .cshero-header-content-widget .header a:hover,
#cshero-header .cshero-header-content-widget .cshero-hidden-sidebar-btn a:hover{
...
#cshero-header ul.cshero-dropdown > li > a:active,
#cshero-header .widget_cart_search_wrap a.icon_search_wrap:active,
#cshero-header .cshero-header-content-widget .header a:active,
#cshero-header .cshero-header-content-widget .cshero-hidden-sidebar-btn a:active{
...
<?php if($smof_data['arrow_parents_item_menu']) {?>
    ...
    .header-v4 .cshero-menu-left .cshero-dropdown li.menu-item-has-children > a {padding-<?php echo esc_attr($smof_data['header_position']); ?>: 30px !important;}
    .header-v4 .cshero-menu-left .cshero-dropdown li.menu-item-has-children > a:before{
        <?php echo esc_attr($smof_data['header_position']); ?>: 5px;
    }

    /* Level 2+ */
    .header-v4 .cshero-menu-left .cshero-dropdown .sub-menu li.menu-item-has-children > a:before{
        left:30px;
    }
    .header-v4 .cshero-menu-left .cshero-dropdown .sub-menu li.menu-item-has-children > a > span{ margin-left:15px; display:block;}
<?php } ?>
