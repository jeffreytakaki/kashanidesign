<?php
	global $smof_data, $portfolio_category, $portfolio_layout, $portfolio_about_project, $portfolio_project_date, $portfolio_project_client, $link;
?>
<article id="cs_post_<?php the_ID(); ?>" <?php post_class('single-small-slider single-post format-gallery row'); ?>>
	    <div class="col-xs-12 col-sm-12 <?php if($smof_data['portfolio_show_date'] || $smof_data['portfolio_show_custom_field'] || $smof_data['portfolio_show_category'] || $smof_data['portfolio_show_share']) echo 'col-md-8 col-lg-8'; else echo 'col-md-12 col-lg-12'; ?>">
	       <?php  
