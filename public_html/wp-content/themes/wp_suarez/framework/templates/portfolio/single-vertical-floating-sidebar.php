...
<article id="cs_post_<?php the_ID(); ?>" <?php post_class('single-'.$portfolio_layout.' format-gallery single-post row'); ?>>
	    ...
	    <?php if($smof_data['portfolio_show_date'] || $smof_data['portfolio_show_custom_field'] || $smof_data['portfolio_show_category'] || $smof_data['portfolio_show_share']){ ?>
				...
				<div class="cs-portfolio-sidebar">
					...
					<div class="cs-portfolio-share">
					    <div class="social-details">
							<h6 class=""><?php echo $smof_data['portfolio_share_title']; ?></h6>
							<a
