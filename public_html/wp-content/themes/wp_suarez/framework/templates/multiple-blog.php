...
function cshero_infobar_style2(){
    ...
    <span class="cshero-info-bar">
        ...
        ?>
        <a href="<?php echo get_day_link(get_the_time('Y'),get_the_time('m'),get_the_time('d')); ?>" title="<?php echo __( "View all posts date ",THEMENAME).$archive_date; ?>"><?php echo esc_attr($archive_date); ?></a>
    </span>
    <?php
    return ob_get_clean();
}
function cshero_get_like_comment(){
    ...
    <ul class="cshero-info-like">
        ...
        <?php if($smof_data['detail_comments']): ?><li class="cs-blog-comments"><a href="<?php echo get_comments_link(get_the_ID());?>"><span class="share-box"><i class="fa fa-comment"></i><?php comments_number(__('0',THEMENAME),__('1',THEMENAME),__('%',THEMENAME));?></span></a></li><?php endif; ?>
    </ul>
<?php endif; ?>
    <?php
    return ob_get_clean();
            ...
            <ul class="unliststyle">
                ...
                if($smof_data['detail_date'] == '1' and in_array('date',$vars)):
                    ...
                    <li class="cs-blog-date">
                        <?php _e('Posted', THEMENAME); ?> <a href="<?php echo get_day_link(get_the_time('Y'),get_the_time('m'),get_the_time('d')); ?>" title="<?php echo __( "View all posts date ",THEMENAME).$archive_date; ?>"><?php echo esc_attr($archive_date); ?></a>
                    </li>
                <?php endif; ?>
