...
<article id="cs_post_<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="row cs-item-team">
		<div class="col-xs-12 <?php if (has_post_thumbnail()) echo 'col-sm-6 col-md-3 col-lg-3'; else echo 'col-sm-12 col-md-12 col-lg-12'; ?> cs-team-details">
			<div class="cs-team-meta">
				<?php if(!empty($about_title)) { ?>
					<h3><?php echo $about_title; ?></h3>
				<?php } ?>
				<?php if ($show_description == true || $show_description == 1) { ?>
					<div class="cs-team-description clearfix"><?php the_content(); ?></div>
				<?php } ?>
				...
				if (!empty($links)) {
					...
					echo '<div class="cs-team-social clearfix"><ul class="cs-social">' . implode('', $links) . '</ul></div>';
				}
