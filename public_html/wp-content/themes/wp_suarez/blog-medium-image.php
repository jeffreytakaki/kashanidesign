...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area<?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?> blog-medium-image<?php echo esc_attr($layout->class); ?> blog-medium-image-wrap">
                ...
                <div class="content-wrap <?php echo esc_attr($layout->blog); ?>">
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( $wp_query->have_posts() ) : ?>
                            ...
                            ?>
                        <?php else : ?>
                            <?php get_template_part( 'framework/templates/blog/small/blog', 'none' ); ?>
                        <?php endif; ?>
                    </main><!-- #main -->
                </div>
