...
$font_style='';
$font_style .='font-weight:'.substr($font_format,0,3).';';
$font_style .='font-style:'.substr($font_format,3).';';
...
$output .= '<div class="'.$atts['style'].' '.$font_container_data['values']['text_align'].' custom-heading-wrap" >';
	...
	$output .= '<' . $font_container_data['values']['tag'] . ' class="cs-heading-tag '.$el_class.'" style="'.$font_style .$line_height.' '. implode( ';', $styles ) . '">';
