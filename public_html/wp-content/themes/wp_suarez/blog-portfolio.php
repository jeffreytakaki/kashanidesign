...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area blog-portfolio-grid <?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?><?php echo esc_attr($layout->class); ?>">
                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( $wp_query->have_posts() ) : ?>
                            ...
                            ?>
                                 ...
                                 */
                                get_template_part( 'framework/templates/blog/portfolio/blog','');
                                ?>
                            <?php endwhile;  ?>
                        </div>
                        <?php else : ?>
