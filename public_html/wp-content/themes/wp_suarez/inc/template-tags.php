...
function cshero_post_nav() {
	...
	<nav class="navigation post-navigation clearfix" role="navigation">
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<i class="fa fa-chevron-left"></i>BACK', THEMENAME ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( 'NEXT<i class="fa fa-chevron-right"></i>', THEMENAME ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
