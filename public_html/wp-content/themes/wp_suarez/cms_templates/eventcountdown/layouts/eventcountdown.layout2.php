<div class="cs-eventCount">
	...
	<div class="cs-eventCount-content">
		...
		<div class="cs-eventCount-contentWrap col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<span class="line-wedding"></span>
			<?php $time_next = get_post_meta(get_the_ID(), 'cmsevent_start_date', true); ?>
			<span id="event_countdown" class="" data-count="<?php echo date('Y-m-d H:i:s', $time_next); ?>" data-label="<?php echo __('DAYS', THEMENAME).','.__('HOURS', THEMENAME).','.__('MINUTES', THEMENAME).','.__('SECONDS', THEMENAME); ?>" data-style="<?php echo esc_attr($number_position); ?>" ></span>
		</div>
		<?php endwhile; ?>
	</div>
</div>