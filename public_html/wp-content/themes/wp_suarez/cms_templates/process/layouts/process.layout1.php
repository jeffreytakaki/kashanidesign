...
<div class="cshero-process-content">
    <ul class="cshero-process-holder clearfix">
        ...
        <li class="cshero-process-outer">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title1); ?></span>
        ...
        <li class="cshero-process-outer">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title2); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
        ...
        <li class="cshero-process-outer">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title3); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
        ...
        <li class="cshero-process-outer item-last">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title4); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
