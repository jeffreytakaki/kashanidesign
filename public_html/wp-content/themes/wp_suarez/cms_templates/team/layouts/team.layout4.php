    ...
    <?php if($show_image) : ?>
        <div class="cshero-team-image clearfix" <?php echo $crop_image_size;?>>
            ...
            <div class="overlay" <?php echo $overlay_style;?>>
                <div class="overlay-content" <?php echo $content_style;?>>
                    ...
                    <?php if ($show_description) { ?>
                        <div class="cshero-team-description"><?php echo cshero_content_max_charlength(strip_tags(strip_shortcodes(get_the_content())), $excerpt_length); ?></div>
                    <?php } ?>
