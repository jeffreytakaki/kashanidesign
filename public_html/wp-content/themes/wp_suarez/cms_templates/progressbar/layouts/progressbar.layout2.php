<?php if(!$vertical): ?>
    <?php if($show_title): ?>
        <div class="cshero-progress-title">
            <<?php echo $title_size; ?> class="title" <?php echo $title_style; ?>><?php if($icon){?><i style="color:<?php echo $icon_color;?>;font-size:<?php echo $icon_size;?>;" class="<?php echo $icon; ?>"></i><?php }?><?php echo $title; ?> <span class="right"><?php
                if($show_value){
                    echo $value.$label_value;
                } ?>
            </span></<?php echo $title_size; ?>>
        </div>
    <?php endif; ?>
