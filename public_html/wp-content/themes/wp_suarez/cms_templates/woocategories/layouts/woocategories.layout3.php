        ...
        <div class="cs-categories-woo-image">
            ...
            <div class="overlay" <?php echo $overlay_style;?>>
                <div class="overlay-content">
                    <a class="btn btn-white" href="<?php echo get_term_link($term->term_id, 'product_cat'); ?>" style="color: <?php echo $title_categories_color; ?>; "><?php echo __('Shop ',THEMENAME).$term->name; ?></a>
                </div>
            </div>
        </div>
