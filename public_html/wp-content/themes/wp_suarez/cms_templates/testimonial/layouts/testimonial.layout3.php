...
<?php if ($quotation_left_icon!='-1') :?>
    <i class="fa <?php echo $quotation_left_icon;?> cshero-testimonial-icon left" style="font-size:<?php echo $quotation_icon_size;?>;color:<?php echo $quotation_color;?>"></i>
<?php endif;?>
...
<?php if ($quotation_right_icon!='-1') :?>
    <i class="fa <?php echo $quotation_right_icon;?> cshero-testimonial-icon right" style="font-size:<?php echo $quotation_icon_size;?>;color:<?php echo $quotation_color;?>"></i>
<?php endif;?>
