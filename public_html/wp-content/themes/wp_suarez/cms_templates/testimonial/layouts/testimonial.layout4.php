        ...
        <div class="cshero-testimonial-description <?php echo $content_align;?>">
            <div class="cshero-testimonial-text" <?php echo $desc_style; ?>>
                ...
                <span class="cshero-testimonial-content <?php echo $content_align;?>">
                    <?php if ($show_title) { ?>
                        <span class="cshero-testimonial-title" style="text-transform:uppercase; font-size:15px; font-weight:400; color:<?php echo $item_title_heading_color;?>">
                            <span style="padding:20px;font-size:15px; <?php echo $item_title_heading_color;?>">-</span><?php the_title() ?>
                        </span>
                    <?php } ?>
