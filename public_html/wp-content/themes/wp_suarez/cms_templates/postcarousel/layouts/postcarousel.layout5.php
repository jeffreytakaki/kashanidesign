...
<article <?php post_class('clearfix'); ?>>
    <div class="cshero-carousel-container">
        <?php if($show_image) { ?>
        <div class="cshero-carousel-image <?php echo $content_align;?>">
            <?php
        ...
        <div class="cshero-carousel-body" style="padding-<?php echo $content_align?>:<?php echo $crop_image? $width_image+20:'20' ?>px;">
            <div class="cshero-carousel-inner" <?php echo $content_style;?>>
