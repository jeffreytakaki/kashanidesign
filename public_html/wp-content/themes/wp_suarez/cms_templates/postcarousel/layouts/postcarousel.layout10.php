    ...
    <div class="cshero-carousel-container">
        ...
        <div class="cshero-carousel-image clearfix" <?php echo $crop_image_size;?>>
            ...
            <div class="overlay <?php echo $overlay_appear;?>">
                <div class="overlay-content" style="<?php echo 'z-index:4;border-radius:'.$image_border.';-webkit-border-radius:'.$image_border.';-moz-border-radius:'.$image_border.';-ms-border-radius:'.$image_border.';-o-border-radius:'.$image_border.';background-color:'.$overlay_bg_color.';color:'.$content_color.';';?>">
