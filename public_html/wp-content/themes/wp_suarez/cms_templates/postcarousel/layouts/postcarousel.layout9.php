<?php 
    $content_padding ='';
    if($content_align =='left' || $content_align =='right') $content_padding = 'padding-'.$content_align.':'.$width_image;
?>
<article <?php post_class(); ?>>
    <div class="cshero-carousel-container">
        <?php if($show_image) { ?>
        <div class="cshero-carousel-image clearfix <?php echo $content_align;?>" <?php echo $crop_image_size;?>>
            <?php
        ...
        <div class="cshero-carousel-body" style="<?php echo $content_padding;?>px" >
            <div class="cshero-carousel-inner clearfix" <?php echo $content_style;?>>
                <?php if ($show_title) { ?>
