    ...
    <div class="cshero-carousel-container">
        ...
        <div class="cshero-carousel-image clearfix" <?php echo $crop_image_size;?>>
            ...
            <?php if ($show_category) : ?>
                <div class="cshero-carousel-post-category" style="background-color:<?php echo $overlay_bg_color;?>;">
                    <?php echo strip_tags (get_the_term_list($post->ID, 'category', '', ', ', '')); ?>
                </div>
            <?php endif; ?>

            <div class="overlay <?php echo $overlay_appear;?>">
                <div class="cshero-carousel-body" <?php echo $content_style;?>>
                    ...
                    <div class="cshero-carousel-meta clearfix">
                        <?php if($show_date) :?>
                            <span class="date" <?php echo $date_style;?>>
                                <?php
                                if($date_format=='time'){
                                    echo cshero_tp_relative_time(get_the_date('Y-m-d H:i'));
                                }
                                else{
        ...
        <div class="cshero-carousel-body" <?php echo $content_style;?>>
            ...
            <div class="cshero-carousel-meta clearfix">
                <?php if($show_date) :?>
                    <span class="date" <?php echo $date_style;?>><i class="fa fa-clock"></i> 
                        <?php
                                    if($date_format=='time'){
                                        echo cshero_tp_relative_time(get_the_date('Y-m-d H:i'));
                                    }
                ...
                <?php endif; ?>
                <?php if($show_category) {?><span><?php echo strip_tags (get_the_term_list($post->ID, 'category', '', ', ', '')); ?></span><?php } ?>
                <?php if($show_comment) :?>
                <span class="cshero-carousel-comment"><i class="fa fa-comment-o"></i>
                    <?php
                    $comments = (int)get_comments_number();
