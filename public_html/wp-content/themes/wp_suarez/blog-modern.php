...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area<?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?> blog-large-image<?php echo esc_attr($layout->class); ?> blog-modern-wrap">
                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( $wp_query->have_posts() ) : ?>
                            ...
                            <?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
                                 ...
                                 */
                                get_template_part( 'framework/templates/blog/modern/blog',get_post_format());
                                ?>
                            <?php endwhile; ?>
                            <?php
                                if($masonry_loadmore){
                            ...
                            ?>
                        <?php else : ?>
                            <?php get_template_part( 'framework/templates/blog/modern/blog', 'none' ); ?>
                        <?php endif; ?>
