...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area<?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?> blog-large-image<?php echo esc_attr($layout->class); ?> blog-magazine-wrap">
            ...
            <div class="row">
                ...
                <div class="content-wrap <?php echo esc_attr($layout->blog); ?>">
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( $wp_query->have_posts() ) : ?>
                            ...
                            <div class="blog-magazine-inner">
                                <?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
                                     ...
                                     */
                                        get_template_part( 'framework/templates/blog/magazine/blog',get_post_format());
                                    ?>
                                <?php endwhile; ?>
                                <?php
                                    if($masonry_loadmore){
                        ...
                        <?php else : ?>
                            <?php get_template_part( 'framework/templates/blog/magazine/blog', 'none' ); ?>
                        <?php endif; ?>
