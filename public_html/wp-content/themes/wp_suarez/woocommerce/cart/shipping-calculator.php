...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2 class="cart-title"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></h2>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-default btn-block"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
