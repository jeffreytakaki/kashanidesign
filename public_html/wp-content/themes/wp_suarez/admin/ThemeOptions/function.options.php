...
if (!class_exists('CSCORE_Base')){
    $disable = ' disabled ';
    $msg = 'You should be installed requirement plugin <strong>CmsSuperHeroes</strong>! If you want to install all our demo data, please install all recommended plugin too !';
} elseif (!class_exists('WPBakeryVisualComposerAbstract')) {
    $disable = ' disabled ';
    $msg = 'You should be installed requirement plugin <strong>WPBakery Visual Composer</strong>! If you want to install all our demo data, please install all recommended plugin too !';
} elseif(!class_exists('CMSEvents') || !function_exists('wpcf7') || !class_exists('Newsletter') || !class_exists('RevSliderAdmin') || !class_exists('TouristTravel') || !class_exists( 'WooCommerce' ) || !function_exists('get_most_rated')) {
    $msg = 'Bravo ! Now you can click Import button to install our demo data!  <strong>But if you want to install all our demo data without lost anything, please install all recommended plugin too</strong>!';
} else {
    $msg = 'Congratulation ! Now click Import button to install our demo data!';
}
$this->sections[] = array(
 ...
 */
$this->sections[] = array(
    'title' => __('Suarez Survey', THEMENAME),
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'text',
            'title' => 'Header Border Bottom Width',
            'default' => '0',
            'required' => array(
                0 => 'header_border_bottom',
                1 => '=',
 ...
 */
$this->sections[] = array(
    'title' => __('Border Button', THEMENAME),
    'icon' => 'el-icon-forward-alt',
    'subsection' => true,
    'fields' => array(
        array(
