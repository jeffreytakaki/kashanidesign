...
$separator_width1 ='';
if($separator_width =='custom'){ $separator_width1 .= $separator_width_custom;} else {$separator_width1 .= $separator_width;}
if($color == 'custom'){
	$color = $accent_color;
}
...
$inline_css = 'style="display:block; width:100%; border-style:'.$style.';border-color:'.esc_attr($color).';border-width: '.esc_attr($border_width).'px 0 0 0;"';

/*$class .= $this->getExtraClass($separator_width);*/
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $class, $this->settings['base'], $atts );
?>
<div class="<?php echo esc_attr(trim($css_class)); ?>" style="width:<?php echo $separator_width1;?>;">
