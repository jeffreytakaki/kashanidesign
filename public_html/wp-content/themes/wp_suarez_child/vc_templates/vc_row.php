...
/* row class */
    $css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,'wpb_row clearfix '. get_row_css_class() . $el_class . $responsive . $main_full_width . vc_shortcode_custom_css_class( $css, ' ' ), $this->settings['base'], $atts );
/* Link Color */
    global $link_style;
    $uqid = uniqid();
