            ...
            <?php
                ...
                if(!empty($term->term_id)){
                    ...
                    if($thumbnail_id){
                        ...
                        $attachment = CSCORE_PLUGIN_URL.'assets/images/no-image.jpg';
                        if($crop_image == '1'){
                            $image_resize = mr_image_resize( $attachment, $width_image, $height_image, true,'c', false );
                        }else{
                            $image_resize = $attachment;
                        }
                    }
                }
            ?>
